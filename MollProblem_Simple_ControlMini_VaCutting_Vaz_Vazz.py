...
def loss(model, X_interior, X_alower, X_zboundary):
    ...
    L4 = loss_neumann_boundary_alower(model, X_alower) + loss_neumann_boundary_alowerzlower(model, X_alower) + loss_neumann_boundary_convex_alower(model, X_alower)
