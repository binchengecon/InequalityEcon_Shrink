...
savefolder = 'baseline_findX_far/Interal=[{},{}]/Slopeid_{}/learning_{}/backup_{}/'.format(args.lowerslope, args.upperslope, idd, starting_learning_rate, backup)
saveName   = 'Sannikov'
saveFigure = False
figureName = saveName
#%% Analytical Solution
...
learning_rate = tf.train.exponential_decay(starting_learning_rate, global_step,50000, 0.95, staircase=True)
