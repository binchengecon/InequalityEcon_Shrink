...
parser.add_argument("--FFNN_alpha", type=float)
...
# Save options
saveOutput = False
savefolder = 'Moll_control_leakyrelu/num_layers_FFNN_{}_activation_FFNN_{}_num_layers_RNN_{}_nodes_per_layer_{}_FFNN_alpha_{}/sampling_stages_{}_steps_per_sample_{}_starting_learning_rate_{}_weight_{}/nSim_interior_{}_nSim_boundary_{}/id_{}/'.format(num_layers_FFNN, activation_FFNN, num_layers_RNN, nodes_per_layer, FFNN_alpha, sampling_stages, steps_per_sample, starting_learning_rate, weight, nSim_interior, nSim_boundary, idd)
...
model = DGM3.DCGM3Net(X_low, X_high, nodes_per_layer, num_layers_FFNN,num_layers_RNN, 2, activation_FFNN, FFNN_alpha)
