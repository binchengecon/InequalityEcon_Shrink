...
# Save options
saveOutput = False
savefolder = 'NoUpper_num_layers_FFNN_{}_num_layers_RNN_{}_nodes_per_layer_{}_sampling_stages_{}_steps_per_sample_{}_nSim_interior_{}_nSim_boundary_{}'.format(num_layers_FFNN, num_layers_RNN, nodes_per_layer, sampling_stages, steps_per_sample, nSim_interior, nSim_boundary)
...
def loss(model, a_interior, z_interior, a_NBC, z_NBC, a_SC_upper, z_SC_upper, a_SC_lower, z_SC_lower):
    ...
    opt_boundary_SC_upper_a = tf.zeros_like(fitted_boundary_SC_upper)
